            ...
            <div class="row" style="margin: 15px 0px">
                <div class="col-md-8" style="padding: 4px">
                    <div class="bg-white" style="padding: 15px 15px">
                        <h5>Products being purchased</h5>
                        <table>
                            <thead style="height: 40px;background: #ccc;font-weight: 900; color: #000">
                            <th style="font-weight: 700; color: #222;font-size: 13px">STT</th>
                            <th style="font-weight: 700; color: #222;font-size: 13px">IMAGE</th>
                            <th style="font-weight: 700; color: #222;font-size: 13px">PRODUCT'S NAME</th>
                            <th style="font-weight: 700; color: #222;font-size: 13px">PRICE</th>
                            <th style="font-weight: 700; color: #222;font-size: 13px">QUANTITY</th>
                            <th style="font-weight: 700; color: #222;font-size: 13px">INTO MONEY</th>
                            <th style="font-weight: 700; color: #222;font-size: 13px">ACT</th>
                            </thead>
                            <?php
                            $stt = 1;
                            $sumSL = 0;
                ...
                <div class="col-md-4" style="padding: 4px">
                    <div class="bg-white" style="padding: 5px 15px">
                        <H5 style="margin-top: 10px; width: 100%; text-align: center">ORDER</H5>
                        <hr>
                        <H5>Information line</H5>
                        <div class="row">
                            <div class="col-6 text-pttt">Total products:</div>
                            <div class="col-6 text-pttt" style="font-weight: 900"> <?php echo $sumSL?></div>
                            <div class="col-6 text-pttt" >Total payment:</div>
                        ...
                        <span style="font-size: 12px; color: #999">*Change the delivery address at <a href="addressbook.php">Address</a>* </span>
                        <hr>
                        <h5>Payment methods</h5>
                            ...
                            <input name="gender" type="radio" value="momo" /><span class="text-pttt"> Payment with momo  <img src="./upload/img/thanh-toan-momo.png" class="img-pttt"></span><br>
                            <input name="gender" type="radio" value="bank" /><span class="text-pttt"> Payment by bank transfer <img src="./upload/img/thanh-toan-chuyen-khoan.png" class="img-pttt"></span><br>
                        <hr>
                        <p>

                           <div style="width: 100%;text-align: center"><button class="btn-info btn" style="font-weight: 600">BOOK NOW</button></div>
                        </form>
                        </p>
                    </div>
                </div>
...
<dialog id="xacnhanxoa" style="padding: 10px 15px;border: none; width: 400px;  box-shadow: 0px 0px 15px 0px #aaa; border-radius: 5px; display: none;">
    <p style="font-size: 16px;">Delete this product!</p>
