            ...
            <div class="row" style="margin: 15px 0px">
                ...
                <div class="col-md-9" style="padding: 4px">
                    <div class="bg-white" style="padding: 15px 15px">
                        <H4>ADDRESS</H4>
                        <span style="color: #999">*Address book is a list of addresses used to order and receive goods*</span>
                        <table>
                            <thead style="height: 40px;background: #ccc;font-weight: 900; color: #000">
                            <th style="font-weight: 900; color: #222">STT</th>
                            <th style="font-weight: 900; color: #222">RECIPIENT'S NAME</th>
                            <th style="font-weight: 900; color: #222">PHONE NUMBER</th>
                            <th style="font-weight: 900; color: #222">DELIVERY ADDRESS</th>
                            <th style="font-weight: 900; color: #222">Act</th>
                            </thead>
                            <?php
                                $dem=0;
...
<dialog id="addAddressbook" style="border: none; width: 500px;  box-shadow: 0px 0px 15px 0px #aaa; border-radius: 5px; display: none">
    ...
    <p style="font-size: 21px; font-weight: 600">Add new shipping address</p>
    <hr>
    <form method="post" action="#" style="text-align: left; margin-top: -25px">
        ...
        <br>
        <p style="font-weight: 500; ">Recipient's name</p>
        ...
        <br><br>
        <button   class="btn btn-info" name="act" value="add" style="float: right">Confirm</button>
    </form>
</dialog>
...
<dialog id="xacnhanxoa" style="padding: 10px 15px;border: none; width: 400px;  box-shadow: 0px 0px 15px 0px #aaa; border-radius: 5px; display: none; ">
    <p style="font-size: 16px;">This will remove the address! are you sure!</p>
...
<dialog id="editit" style="padding: 15px 10px;border: none; width: 500px;  box-shadow: 0px 0px 15px 0px #aaa; border-radius: 5px; display: none;position: fixed; top:50%;left: 50%;  transform: translate(-50%,-50%);">
    ...
    <p style="font-size: 21px; font-weight: 400">Edit account information</p>
    <hr style="margin-top: -5px; margin-bottom: 5px">
    <form method="post" action="#" style="text-align: left">
        <input type="hidden" id = "id" name="id" value="" style="display: none" >
        <span style="font-weight: 400; ">Recipient's name</span><br>
        ...
        <br> <br><span style="font-weight: 400">Phone number</span><br>
        ...
        <br><br><span style="font-weight: 400">Address</span><br>
        <input class="form-control-sm" id="address" type="text" name="address" required value="" style="width: 100%; border: solid 1px #333">
        <p></p>
        <button   class="btn btn-info" id="xacnhanedit" name="act" value="edit" style="float: right; padding: 2px 5px">Confirm</button>
    </form>
</dialog>
