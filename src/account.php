            ...
            <div class="row" style="margin: 15px 0px">
                ...
                <div class="col-md-9" style="padding: 4px">
                        <div class="bg-white" style="padding: 15px 15px">
                            ...
                            <button class="btn btn-info" onclick=" editInfoUser()">Edit information</button>
                            ...
                            <dialog id="editit" style="border: none; width: 500px;  box-shadow: 0px 0px 15px 0px #aaa; border-radius: 5px; display: none">
                                ...
                                <p style="font-size: 21px; font-weight: 600">Edit account information</p>
                                <hr>
                                <form method="post" action="#" style="text-align: left">
                                    <input type="hidden" id = "editid" name="id" value="" style="display: none">
                                    <br>
                                    <p style="font-weight: 500; ">Full name</p>
                                    ...
                                    <p></p>
                                    <button   class="btn btn-info" id="xacnhandelete" name="act" value="edit" style="float: right">Confirm</button>
                                </form>
                            </dialog>
