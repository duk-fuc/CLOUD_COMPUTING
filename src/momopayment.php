...
<html>
<head>
    <title>Payment for orders via momo</title>
    ...
    <div class="content">
        <div class="container">
            <div class="bg-white" style="margin-top: 20px;padding-bottom: 25px ; padding: 15px; text-align: center;">
                <H2 style="margin-top: 15px; color: #fd7e14">PROCESSING MONEY TRANSFER PAYMENT THROUGH MOMO</H2>
                <br>
                <div style="width: 100%; max-width: 600px; margin: auto">
                    <p style="background: #027dc1; color: #fff; font-weight: 400; font-size: 20px; border-left: solid 5px #fd7e14;">Please transfer money to your account <span style="font-weight: 600">MOMO</span> our information below for us to confirm your payment</p>
                </div>
                <div style="width: 100%; max-width: 600px; margin: auto">
                    <br>
                    <div style="background: #f0f5f5; border: solid 2px #a2c5c5; border-radius: 5px; text-align: left; padding: 10px; ">
                        <p>
                            <span style="font-size: 18px">Phone number</span><br>
