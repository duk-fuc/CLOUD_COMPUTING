            ...
            <div class="row" style="margin: 15px 0px">
                ...
                <div class="col-md-9" style="padding: 4px">
                    <div class="bg-white" style="padding: 15px 15px">
                        <h2 style="margin-top: 15px">Cart</h2>
                        <hr>
                        <table>
                            <thead style="height: 40px;background: #ccc;font-weight: 900; color: #000">
                            <th style="font-weight: 900; color: #222">STT</th>
                            <th style="font-weight: 900; color: #222">IMAGE</th>
                            <th style="font-weight: 900; color: #222">PRODUCT'S NAME</th>
                            <th style="font-weight: 900; color: #222">PRICE</th>
                            <th style="font-weight: 900; color: #222">QUANTITY</th>
                            <th style="font-weight: 900; color: #222">INTO MONEY</th>
                            ...
                            $sumSL = 0;
                            $sumTT = 0;
                            if(sizeof($getCart)==0) echo "<tr class='tr2'><td colspan='7' style='text-align: center; font-size: 20px; font-weight: 600; '>Cart is empty</td></tr>";
                            ...
                            <tr style="background: #e2e2e2;font-weight: 900; color: #c82333" >
                                <td colspan="4" style="font-weight: 900;padding-left: 35px; ">TOTAL</td>
                        ...
                        <div style="margin-top: 10px; text-align: right">
                            <form action="purchase.php">
                                <?php if ($sumSL>0) echo '<button class="btn btn-info" style="font-weight: 600">PAY NOW</button>'; else echo "<br><br>"?>
                            </form>
                        </div>
                    </div>
                </div>
